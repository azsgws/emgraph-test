...
$(function(){
    $.when(
        ...
        $.getJSON('./graph_attrs/sfdp_graph_2019_03_29_hits_authority.json'),
        $.getJSON('./graph_attrs/sfdp_graph_2019_03_29_hits_hub.json'),
        $.getJSON('./graph_attrs/sfdp_graph_2019_03_29_pagerank.json'),
        $.getJSON('./graph_attrs/dot_graph_2020-06-18_authority_minus_pagerank.json'),
        ...
        $.getJSON('./graph_attrs/dot_graph_2003-12-24_authority_minus_pagerank.json'),
        ...
        $.getJSON('./graph_attrs/dot_graph_2005-05-31_authority_minus_pagerank.json'),
    ...
    .then((dot_graph_auth, dot_graph_hub, dot_graph_pagerank,
        ...
        dot_graph_2012_auth, dot_graph_2012_hub, dot_graph_2012_pagerank, dot_2012_auth_minus_pagerank,) => {
        // cytoscapeグラフの作成(初期化)
        ...
        else if(layout==='dot_2003_auth'){
            graph = dot_graph_2003_auth[0];
        }
        else if(layout==='dot_2003_hub'){
            graph = dot_graph_2003_hub[0];
        }
        ...
        else if(layout==='dot_2005_hub'){
            graph = dot_graph_2005_hub[0];
        }
        ...
        else if(layout==='dot_2012_hub'){
            graph = dot_graph_2012_hub[0];
        }
